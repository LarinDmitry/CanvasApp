...
ctx.fillText('HelloWorld!', 150, 150); // ctx.fillText('HelloWorld!', canvas.width/2, canvas.height/2);
///////////////////////////////////////////////////////////////////////////

//ВЫВЕСТИ ТЕКСТ ГРАДИЕНТ
///////////////////////////////////////////////////////////////////////////
var grad=ctx.createLinearGradient(0,0,500,0); //от до
grad.addColorStop('0', 'magenta'); //0%
grad.addColorStop('.50', 'blue');  //50%
grad.addColorStop('1', 'red'); //100%

ctx.fillStyle=grad;
ctx.font='30px Georgia';
ctx.fillText('HelloWorld!', 50, 70);
///////////////////////////////////////////////////////////////////////////*/
